...
$level = $_SESSION['profession'] ?? 'Visiteur';
?>
...
<div class="main-content">
    ...
    <div class="sidebar">
<!-- ======= Titre de page ARDHU ======= -->
<div class="page-title text-center my-4" data-aos="fade-down">
<center>
  <img src="apropos/logo.jpg" width="20%" alt="Logo ARDHU" class="mb-2">
  <h1 style="color:#800020; font-weight:700; margin-top:10px;">ONG ARDHU</h1>
  <p class="text-muted" style="font-size:1rem; margin-bottom:1.5rem;">
    Action pour le Respect des Droits de l’Homme et Dignité Humaine
  </p>

  <a href="apropos.php" class="btn btn-primary" 
     style="background-color:#800020; border:none; border-radius:30px; padding:10px 20px; font-weight:600;">
    <i class="fas fa-building"></i> Visiter
  </a>
  </center>
</div>
 </br>
    ...
    <a href="amis.php" class="menu-item"><i class="fas fa-user-friends"></i> Membres</a>&nbsp;&nbsp;&nbsp;
    <a href="messages.php" class="menu-item"><i class="fas fa-comments"></i> Forum</a><br>
</div>
...
<?php else: ?>
    ...
    <div class="hero">
        <div class="hero-banner">
            <h1>Bienvenue sur ARDHU CONNECT</h1>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  feed.addEventListener('click', function(e) {
    ...
    if (shareBtn) {
      ...
      if (navigator.share) {
        navigator.share({
          title: "Publication ARDHU Connect",
          text: "Découvre ce post sur ARDHU Connect",
          url: url
        })
        .catch(() => {/* ignore cancel */});
        return;

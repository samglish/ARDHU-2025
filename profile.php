...
<div class="profile-container">
    <div class="profile-header">
        ...
        <div class="profile-info">
            <h1><?= $full_name ?></h1>
            <p class="profile-level"><?= htmlspecialchars($user['profession'] ?? 'Profession non définie') ?></p>
            <p class="profile-bio"><?= htmlspecialchars($user['bio'] ?? 'Pas de bio pour le moment.') ?></p>
             <p class="profile-region"><?= htmlspecialchars($user['ville'] ?? 'Ville non définie.') ?> | <?= htmlspecialchars($user['quartier'] ?? 'Quartier non défini.') ?></p>
